'''
1. Write program to generate number 1 to given number:
input 5: outut  1 2 3 4 5
...
4.Separate the digits of a given number ?
...
2.Count the factors of a given number
...
num = 5     5 is prime number
num = 7     7 is Prime number
num = 18    18 is not prime number

5.Check given number is Perfect or not ?
num = 6         factors = 1+2+3 => factors sum = 6
num = 28        factors = 1+2+4+7+14 => factors sum = 28
